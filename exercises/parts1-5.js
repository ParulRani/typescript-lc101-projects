...
var spaceLoc = new SpaceLocation_1.SpaceLocation(spaceShuttle.name, spaceShuttle.speedMph, kilometersToMars);
...
spaceLoc.printDaysToLocation(new SpaceLocation_1.SpaceLocation('Mars', spaceShuttle.speedMph, kilometersToMars));
spaceLoc.printDaysToLocation(new SpaceLocation_1.SpaceLocation('the Moon', spaceShuttle.speedMph, kilometersToTheMoon));
